...
public class ServicioCategory {
	...
	public Category actualizarCategory(Category cancion) {
		return this.repositorioCategory.save(cancion);
	}

	public Category obtenerPorNombre(String nombre) {
		return this.repositorioCategory.getByNombre(nombre);
	}
}
